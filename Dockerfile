...
RUN bundle config set frozen false && bundle install && \
    ...
    ls -lah /usr/local/bundle/ruby/3.3.0/extensions/aarch64-linux && \
    ls -lah /usr/local/bundle/ruby/3.3.0/extensions/aarch64-linux/3.3.0 && \
    ls -lah /usr/local/bundle/ruby/3.3.0/extensions/aarch64-linux/3.3.0/ox-2.14.25 && \
    ls -lah /usr/local/bundle/ruby/3.3.0/extensions/aarch64-linux/3.3.0/ox-2.14.25/ox && \
    ls -lah /usr/local/bundle/ruby/3.3.0/extensions/aarch64-linux/3.3.0/ox-2.14.25/ox/ox.so && \
