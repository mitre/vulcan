...
# Paired validate half of the 2-pass FK pattern from
# 20260502080000_change_review_responding_to_fk_to_restrict.
#
# Pre-fix, that migration ran add_foreign_key (validate: false) AND
...
# affected page. Matches the pattern already used for the lifecycle
