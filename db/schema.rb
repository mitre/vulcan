...
ActiveRecord::Schema.define(version: 20_250_611_154_529) do
  ...
  create_table 'additional_answers', force: :cascade do |t|
    ...
    t.index %w[rule_id additional_question_id],
            name: 'index_additional_answers_on_rule_id_and_additional_question_id', unique: true
  ...
  create_table 'additional_questions', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[component_id name], name: 'index_additional_questions_on_component_id_and_name', unique: true
  ...
  create_table 'base_rules', force: :cascade do |t|
    ...
    t.index %w[rule_id component_id], name: 'rule_id_and_component_id', unique: true
  ...
  create_table 'memberships', force: :cascade do |t|
    ...
    t.index %w[user_id membership_type membership_id], name: 'by_user_and_membership', unique: true
  ...
  create_table 'project_access_requests', force: :cascade do |t|
    ...
    t.index %w[user_id project_id], name: 'index_project_access_requests_on_user_id_and_project_id', unique: true
  ...
  create_table 'rule_satisfactions', id: false, force: :cascade do |t|
    ...
    t.index %w[rule_id satisfied_by_rule_id], name: 'index_rule_satisfactions_on_rule_id_and_satisfied_by_rule_id',
                                              unique: true
    t.index %w[satisfied_by_rule_id rule_id], name: 'index_rule_satisfactions_on_satisfied_by_rule_id_and_rule_id',
                                              unique: true
  end
  ...
  create_table 'security_requirements_guides', force: :cascade do |t|
    ...
    t.date 'release_date'
    t.string 'name'
    t.index %w[srg_id version], name: 'security_requirements_guides_id_and_version', unique: true
  end
  ...
  create_table 'stigs', force: :cascade do |t|
    ...
    t.datetime 'updated_at', precision: 6, null: false
    t.string 'name', null: false
    t.index %w[stig_id version], name: 'stigs_stig_id_version_index', unique: true
  end
