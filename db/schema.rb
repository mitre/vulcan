...
ActiveRecord::Schema.define(version: 20181101174651) do
  ...
  create_table "db_users", force: :cascade do |t|
    ...
    t.index ["reset_password_token"], name: "index_db_users_on_reset_password_token", unique: true
  end
  ...
  create_table "ldap_users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_ldap_users_on_email", unique: true
