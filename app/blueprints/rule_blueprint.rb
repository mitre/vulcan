...
class RuleBlueprint < Blueprinter::Base
  ...
  # Per-rule comment summary surfaced on the navigator + section icon
  # badges. One shared definition across document kinds — see
  # CommentSummaryField for the "open" semantics.
