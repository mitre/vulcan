 ...
 * core SRG families only, stig components from derived (non-core)
 * families only. The source picker filters by this so ineligible
 * parents are never offered — the backend validation still stands as
