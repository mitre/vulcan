...
describe("ComponentCard display logic", () => {
  describe("control count display", () => {
    test("shows parent count when parent_rules_count > 0", () => {
      const component = {
        rules_count: 273,
    ...
    test("shows regular count when parent_rules_count is 0", () => {
      const component = {
        rules_count: 191,
    ...
    test("shows singular form for 1 parent", () => {
      const component = {
        rules_count: 50,
    ...
    test("shows singular form for 1 control when no parents", () => {
      const component = {
        rules_count: 1,
        parent_rules_count: 0,
      };
