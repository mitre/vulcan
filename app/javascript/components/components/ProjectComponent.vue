  ...
  <div>
    ...
    <b-row class="align-items-center">
      <b-col md="8">
        <h1>
          {{ component.name }}
          <i v-if="component.released" class="bi bi-patch-check" aria-hidden="true" />
        </h1>
      </b-col>
        ...
        <b-tabs v-model="componentTabIndex" content-class="mt-3" justified>
          ...
          <b-tab :title="`Controls (${component.rules.length})`">
            ...
            <RulesReadOnlyView
              ...
              @rule-selected="updateSelectedRule"
            />
          </b-tab>
          ...
          <b-row class="pb-2">
            <b-col>
              <div class="clickable" @click="showDetails = !showDetails">
                ...
                <i v-if="showDetails" class="bi bi-chevron-down" />
                <i v-if="!showDetails" class="bi bi-chevron-up" />
              </div>
          ...
          <b-row class="pb-2">
            <b-col>
              <div class="clickable" @click="showMetadata = !showMetadata">
                ...
                <i v-if="showMetadata" class="bi bi-chevron-down" />
                <i v-if="!showMetadata" class="bi bi-chevron-up" />
              </div>
          ...
          <b-row class="pb-2">
            <b-col>
              <div class="clickable" @click="showAdditionalQuestions = !showAdditionalQuestions">
                ...
                <i v-if="showAdditionalQuestions" class="bi bi-chevron-down" />
                <i v-if="!showAdditionalQuestions" class="bi bi-chevron-up" />
              </div>
              <b-collapse id="collapse-metadata" v-model="showAdditionalQuestions">
                ...
                >
                  <p v-linkified class="ml-2 mb-0 mt-2">
                    ...
                    <template v-if="value.question_type === 'url'">
                      URL
                    </template>
                    <template v-else>
                      Freeform Text
          ...
          <b-row class="pb-2">
            <b-col>
              <div class="clickable" @click="showHistory = !showHistory">
                ...
                <i v-if="showHistory" class="bi bi-chevron-down" />
                <i v-if="!showHistory" class="bi bi-chevron-up" />
              </div>
          ...
          <b-row class="pb-2">
            <b-col>
              <div class="clickable" @click="showReviews = !showReviews">
                ...
                <i v-if="showReviews" class="bi bi-chevron-down" />
                <i v-if="!showReviews" class="bi bi-chevron-up" />
              </div>
              <b-collapse id="collapse-metadata" v-model="showReviews">
                <div v-for="review in shownReviews" :key="review.id">
                  ...
                  <p class="ml-3 mb-2 white-space-pre-wrap">
                    {{ review.comment }}
                  </p>
                </div>
