...
describe("BasicRuleForm", () => {
  ...
  describe("checkFormFields computed property", () => {
    test("shows check fields when status is Applicable - Configurable", () => {
    ...
    test("shows check fields when rule has satisfied_by relationships", () => {
      const computed = testComputed("checkFormFields", {
        rule: {
          ...mockRule,
          status: "Not Yet Determined",
    ...
    test("hides check fields when status is Not Yet Determined and no satisfied_by", () => {
      const computed = testComputed("checkFormFields", {
  ...
  describe("disaDescriptionFormFields computed property", () => {
    test("shows vuln_discussion when status is Applicable - Configurable", () => {
    ...
    test("shows vuln_discussion when rule has satisfied_by relationships", () => {
      const computed = testComputed("disaDescriptionFormFields", {
        rule: {
          ...mockRule,
          status: "Not Yet Determined",
    ...
    test("shows vuln_discussion as disabled for Not Yet Determined without satisfied_by", () => {
      const computed = testComputed("disaDescriptionFormFields", {
        rule: { ...mockRule, status: "Not Yet Determined", satisfied_by: [] },
      });
    ...
    test("shows mitigation fields when status is Applicable - Does Not Meet", () => {
      const computed = testComputed("disaDescriptionFormFields", {
