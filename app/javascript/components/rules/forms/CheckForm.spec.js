...
describe('checkForm', () => {
  ...
  describe('tooltips computed property', () => {
    it('shows correct tooltip for Applicable - Configurable status', () => {
    ...
    it('shows correct tooltip when rule has satisfied_by (treated as configurable)', () => {
      const computed = testComputed('tooltips', {
        rule: {
          ...mockRule,
          status: 'Not Yet Determined',
    ...
    it('shows different tooltip for other statuses without satisfied_by', () => {
      const computed = testComputed('tooltips', {
    ...
    it('shows null tooltip for Applicable - Inherently Meets', () => {
      const computed = testComputed('tooltips', {
