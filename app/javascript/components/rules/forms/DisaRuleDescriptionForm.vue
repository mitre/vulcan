  ...
  data: function () {
    return {
      ...
      tooltips: {
        ...
        potential_impacts: 'List the potential operational impacts on a system when applying fix discussed in this control',
        third_party_tools: null,
        mitigation_control: 'Discuss how the system mitigates this vulnerability in the absence of a configuration that would elimiate it',
        responsibility: null,
        ia_controls: null,
      },
    };
