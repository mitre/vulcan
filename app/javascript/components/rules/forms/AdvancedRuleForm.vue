    ...
    <b-form>
      ...
      <!-- <template v-if="rule.status == 'Applicable - Configurable'">
        <div @click="showRuleDescriptions = !showRuleDescriptions" class="clickable mb-2">
          ...
          <i class="bi bi-chevron-down superVerticalAlign collapsableArrow" v-if="showRuleDescriptions"></i>
          <i class="bi bi-chevron-up superVerticalAlign collapsableArrow" v-if="!showRuleDescriptions"></i>
        </div>
        <b-collapse v-model="showRuleDescriptions">
          ...
          <b-button class="mb-2" @click="$root.$emit('add:description', rule)" v-if="!disabled"><i class="bi bi-plus"></i>Add Description</b-button>
        </b-collapse>
      </template> -->
      ...
      >
        <div class="clickable mb-2" @click="showDisaRuleDescriptions = !showDisaRuleDescriptions">
          ...
          <i v-if="showDisaRuleDescriptions" class="bi bi-chevron-down" />
          <i v-if="!showDisaRuleDescriptions" class="bi bi-chevron-up" />
        </div>
      ...
      <template v-if="rule.satisfied_by.length > 0 || rule.status == 'Applicable - Configurable'">
        <div class="clickable mb-2" @click="showChecks = !showChecks">
          ...
          <i v-if="showChecks" class="bi bi-chevron-down" />
          <i v-if="!showChecks" class="bi bi-chevron-up" />
        </div>
