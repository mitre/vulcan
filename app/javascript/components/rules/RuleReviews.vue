<template>
  <div>
    ...
    <div class="clickable" @click="showReviews = !showReviews">
      <h2 class="m-0 d-inline-block">Reviews</h2>
      <b-badge pill class="superVerticalAlign">{{ "todo" }}</b-badge>
    ...
    <b-collapse id="collapse-comments" v-model="showReviews">
      <!-- All reviews -->
      <div v-for="review in rule.reviews" :key="review.id">
      ...
      <!-- New review action -->
      <!-- 
        b-dropdown caused display issues with vertically-large review panes,
        so switched to this method 
      -->
      <b-button class="dropdown-toggle" variant="primary" @click="showReviewPane = !showReviewPane">
        Review
      </b-button>
      <b-form @submit="reviewFormSubmitted">
        <div class="reviewDropdownContainer">
          <b-card v-if="showReviewPane">
            <!-- Submit button -->
            <template #header>
              Compelte a Review
              <i
    ...
    reviewActions: function () {
      let actions = [
        ...
        },
        {
          ...
          description: "dismiss the requested review and request changes on the control",
          disabledTooltip: "",
        },
        {
          value: "approve",
        ...
        },
        {
          value: "lock_control",
          name: "Lock Control",
          description: "skip the review process and immediately lock the control",
          disabledTooltip: "",
        },
        {
