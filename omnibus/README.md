...
```shell
$ bin/omnibus clean vulcan
```

Adding the `--purge` purge option removes __ALL__ files generated during the
build including the project install directory (`/opt/vulcan`) and
the package cache directory (`/var/cache/omnibus/pkg`):

```shell
$ bin/omnibus clean vulcan --purge
```
...
[vagrant@ubuntu...] $ cd vulcan
[vagrant@ubuntu...] $ bundle install
[vagrant@ubuntu...] $ ...
[vagrant@ubuntu...] $ bin/omnibus build vulcan
```
