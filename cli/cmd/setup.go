...
# See config/vulcan.default.yml for detailed documentation.
...
# VULCAN_ENABLE_LOCKABLE=true
# VULCAN_LOCKABLE_MAX_ATTEMPTS=5
# VULCAN_LOCKABLE_UNLOCK_IN_MINUTES=30

# =============================================================================
# OIDC AUTHENTICATION (Okta, Auth0, Azure AD, Keycloak, etc.)
# =============================================================================
...
# VULCAN_OIDC_DISCOVERY=true
{{- end }}
# Advanced OIDC options (usually not needed with discovery enabled)
# VULCAN_OIDC_HOST=your-domain.okta.com
# VULCAN_OIDC_PORT=443
# VULCAN_OIDC_SCHEME=https
# VULCAN_OIDC_CLIENT_SIGNING_ALG=RS256
# VULCAN_OIDC_PROMPT=login
# Manual endpoint overrides (only if discovery fails)
# VULCAN_OIDC_AUTHORIZATION_URL=
# VULCAN_OIDC_TOKEN_URL=
# VULCAN_OIDC_USERINFO_URL=
# VULCAN_OIDC_JWKS_URI=
...
# VULCAN_LDAP_ADMIN_PASS=your-password
{{- end }}
# VULCAN_LDAP_TITLE=LDAP
# VULCAN_LDAP_ATTRIBUTE=uid
# VULCAN_LDAP_ENCRYPTION=plain  # Options: plain, start_tls, simple_tls

# =============================================================================
# APP BANNER (colored bar at top/bottom of every page)
# =============================================================================
# VULCAN_BANNER_ENABLED=false
# VULCAN_BANNER_TEXT=Development Environment
# VULCAN_BANNER_BACKGROUND_COLOR=#198754
# VULCAN_BANNER_TEXT_COLOR=#ffffff

# =============================================================================
# CONSENT BANNER (modal shown before login)
# =============================================================================
# Users must acknowledge before accessing the application.
# Increment version to force all users to re-acknowledge after policy changes.
# Content supports markdown formatting.
# VULCAN_CONSENT_BANNER_ENABLED=false
# VULCAN_CONSENT_BANNER_VERSION=1
# VULCAN_CONSENT_BANNER_TITLE=Terms of Use
# VULCAN_CONSENT_BANNER_TITLE_ALIGN=center
# VULCAN_CONSENT_BANNER_CONTENT=Custom consent text here (markdown supported)
...
# VULCAN_SLACK_CHANNEL_ID=C01234567
...
# - config/vulcan.default.yml (all options with defaults)
