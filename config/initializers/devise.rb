...
Devise.setup do |config|
  ...
  config.lock_strategy = Settings.lockable.enabled ? :failed_attempts : :none
  ...
  # is failed attempts. Configurable via VULCAN_LOCKABLE_MAX_ATTEMPTS.
  config.maximum_attempts = Settings.lockable.max_attempts

  # Time interval to unlock the account if :time is enabled as unlock_strategy.
  # Configurable via VULCAN_LOCKABLE_UNLOCK_IN_MINUTES.
  config.unlock_in = Settings.lockable.unlock_in_minutes.minutes
